...
- This code is designed to function in the MATLAB R2024B. It may not work as intended in other versions.
- The "Indent Identifier" folder must be downloaded for the script to work as intended, as it references files within that folder.
...
- The following video goes over how to train the YOLO and Cascade computer vision models with your own data.
	https://drive.google.com/file/d/1L-DkCXonmvbFZBmnTlHlcEvec_SxRFHQ/view?usp=sharing 
- The following video goes over the basic functionalities of this program.
	https://drive.google.com/file/d/1FPcItyLYDvLYvj6u_8y9c8e9E-BmI019/view?usp=sharing
- If you have any inquiries about the algorithm, reach out to Eduardo Pereyra at eduardo.andres.pereyra@gmail.com
